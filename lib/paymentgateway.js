...
class ChainModule {
        ...
        return new Promise(async (resolve, reject) => {
            try {
                ...
                for (const txid of transactions) {
                    ...
                    let txTimestamp;
                    if (this.isCoinbase || this.isTebex || this.isSellix || this.isCraftingStore || this.isPayPal || this.isXsolla) {
    ...
    async createPayment(chargeData) {
        ...
        throw new Error('Payment creation only supported for Coinbase, PayPal, or Xsolla');
    }
