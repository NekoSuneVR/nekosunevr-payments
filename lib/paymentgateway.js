...
class ZNZModule {
    constructor() {
       this.explorerUrl = 'https://znzexplorer.alloyxuast.co.uk/api/v1/';
    }
...
class DOGECModule {
    constructor() {
       this.explorerUrl = 'https://dogecexplorer.alloyxuast.co.uk/api/v1/';
    }
...
class SCCModule {
    constructor() {
       this.explorerUrl = 'https://sccexplorer.alloyxuast.co.uk/api/v1/';
    }
