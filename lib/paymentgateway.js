...
class PaymentAPI {
    ...
    async getAddressTransactions(address) {
        ...
        return this.fetchData(`address/${address}`, { params: { details: 'txs' } }).then(data => {
...
const chainConfigs = {
    ...
    bnb: { url: 'https://api.nekosunevr.co.uk/v5/pay/gateways/api/bnb/', isBNB: true, isEVM: true, evmDecimals: 18 },
    ...
    pol: { url: 'https://pol1.trezor.io/api', isSteemFork: false, isEVM: true, evmDecimals: 18 },
