...
const explorerChains = {
    ...
    dogec: { url: 'https://dogecexplorer.alloyxuast.co.uk/api/v1/', isSteemFork: false, explorerOffline: true },
    znz: { url: 'https://znzexplorer.alloyxuast.co.uk/api/v1/', isSteemFork: false, explorerOffline: true },
...
const fiatGateways = {
    ...
    paymentwall: { url: 'https://api.paymentwall.com/api/', isPaymentwall: true, gatewayType: 'paymentwall' },
    ...
    worldpay: { url: 'https://access.worldpay.com/', isWorldpay: true, gatewayType: 'worldpay' },
    ...
    ofx: { url: 'https://api.ofx.com/v1/', isOFX: true, gatewayType: 'ofx' },
...
const cryptoGateways = {
    ...
    gourl: { url: 'https://coins.gourl.io/', isGoURL: true },
    bitpay: { url: 'https://bitpay.com/', isBitPay: true, gatewayType: 'bitpay' },
    coingate: {
        url: 'https://api.coingate.com/v2/', gatewayType: 'coingate', verified: true,
    ...
    blockonomics: {
        url: 'https://www.blockonomics.co/api/', gatewayType: 'blockonomics', category: 'gateway-payout', verified: true,
...
const gamingGateways = {
    ...
    craftingstore: { url: 'https://api.craftingstore.net/v2/', isCraftingStore: true },
    // Sellix was reportedly seized / shut down in early 2024 — verify before relying on it.
    sellix: { url: 'https://dev.sellix.io/v1/', isSellix: true, deprecated: true },
    paynow: {
    ...
    // (and carries trust warnings). Marked deprecated — verify before production use.
    sellpass: {
